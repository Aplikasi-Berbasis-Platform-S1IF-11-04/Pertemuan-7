    ...
    public function run(): void
    {
        ...
        $spareparts = [
            [
                ...
                'description' => 'Kampas rem depan orisinil Yamaha untuk tipe matic (Beat, Scoopy, Vario).',
            ],
            [
                ...
                'description' => 'Busi standar untuk Yamaha Vario 125/150, PCX, dan ADV.',
            ],
            [
                ...
                'description' => 'V-Belt orisinil Yamaha untuk transmisi CVT motor matic.',
            ],
            [
                'part_number' => 'SPX2-1L',
                ...
                'description' => 'Oli mesin sintetik full untuk performa mesin matic Yamaha.',
            ],
        ];
